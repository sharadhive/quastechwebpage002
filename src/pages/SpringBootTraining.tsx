...
const SpringBootTraining = () => {
  ...
  const modules = [
    ...
    { title: "Microservices", topics: ["Microservices Architecture", "Service Discovery", "API Gateway", "Load Balancing"] },
    { title: "Database Integration", topics: ["Spring Data JPA", "Hibernate", "MySQL", "MongoDB"] }
  ];

  return (
    <DarkModeProvider>
      <SEO title="Spring Boot Course - Microservices Development Training" description="Learn Spring Boot framework, build RESTful APIs, microservices, and enterprise applications." keywords="spring boot, spring framework, microservices, REST API" canonical="/spring-boot-training" ogImage="/images/course images/java.jpg" category="IT Courses" />
