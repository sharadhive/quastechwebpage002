...
const ISTQBCertification = () => {
  ...
  // ISTQB Certification Curriculum Modules
  const curriculumModules = [
    {
      ...
      topics: [
        ...
        "Test Work Products",
        "Traceability between Test Basis",
        "Roles in Testing",
    ...
    },
    {
      ...
      topics: [
        ...
        "Activities of Work Product Review",
    ...
    },
    {
      ...
      topics: [
        ...
        "Value of Statement and Branch Testing",
    ...
    },
    {
      ...
      topics: [
        ...
        "Purpose and Content of Test Reports",
        "Configuration Management",
        "Risk and Testing",
        "Definition and Risk Attributes",
    ...
    },
    {
      ...
      topics: [
        ...
        "Tool Support for Performance Measurement",
        "Tool Support for Specialized Testing",
        "Effective Use of Tools",
        "Main Principles for Tool Selection",
        "Pilot Projects for Tool Introduction",
        ...
        <section className="py-8 md:py-12 bg-gradient-to-br from-slate-50 via-blue-50 to-purple-50">
          <div className="container mx-auto px-4">
            ...
            >
              <h2 className="text-3xl md:text-4xl font-extrabold mb-6">
                <span className="bg-gradient-to-r from-blue-600 via-purple-600 to-orange-500 bg-clip-text text-transparent">
                  Tools & Technologies You'll Master in ISTQB Certification Training
                </span>
              </h2>
